...
\tfrac{n\cdot (n+2)}{2}\cdot\zh
&\ge
\tfrac{n-4}{2\cdot(n-2)}\cdot |H|^2
+
\tfrac{n-1}{n-2}\cdot(|H|+ 2\cdot k\cdot|\iota|\cdot \cos\alpha)^2+
\\
&\qquad+4\cdot \tfrac{n-1}{n-2}\cdot(k\cdot n-k^2\cdot|\iota|^2\cdot[\cos^2\alpha+\sin^2\beta])=
\\
&=\tfrac32\cdot(|H|+\tfrac{4\cdot (n-1)}{3\cdot(n-2)}\cdot k\cdot|\iota|\cdot\cos\alpha)^2+
\\
&\qquad
+4\cdot \tfrac{n-1}{n-2}\cdot
(k\cdot n-k^2\cdot|\iota|^2
\cdot
[\sin^2\beta+(1-\tfrac{n-4}{3\cdot (n-2)})\cdot(\cos\alpha)^2])\ge
\\
&\ge  \tfrac{n-1}{n-2}\cdot \frac{n^2}{
|\iota|^2
\cdot
[\sin^2\beta+(1-\tfrac{n-4}{3\cdot (n-2)})\cdot(\cos\alpha)^2]}\ge
\\
&\ge\tfrac{3}{2}\cdot n^2.
\end{align*}
...
\section{Better embeddings into ball}
